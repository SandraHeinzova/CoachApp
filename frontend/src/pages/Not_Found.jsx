...
function NotFound() {
    ...
    return (
        <div className="error-page-full"> {/* Opraveno */}
            <main className="error-card"> {/* Opraveno */}
                <h1 className="error-code">404</h1>
                <div className="error-illustration"> {/* Opraveno */}
                ...
                <Link to="/dashboard" className="btn-error-home"> {/* Opraveno */}
